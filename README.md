# PMapper (Principal Mapper) & AWS Privilege Escalation Matrix

## What's New? (2026 Update)
PMapper now supports over **180+ AWS Privilege Escalation vectors** natively integrated! We've researched and mapped these to the MITRE ATT&CK Cloud Matrix. 
...
# Original PMapper Documentation
